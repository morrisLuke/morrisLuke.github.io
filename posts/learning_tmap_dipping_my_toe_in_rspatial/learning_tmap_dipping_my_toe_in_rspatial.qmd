...
[`tmap` Github](https://r-tmap.github.io/tmap/index.html) [r-spatial.org](https://r-spatial.org/) [Geocomputation with R](https://r.geocompx.org/adv-map.html) [`tmap`: Elegant and Effective Informative Maps book (incomplete)](https://r-tmap.github.io/tmap-book/) Did I miss a good one? Comment and shout it out!
